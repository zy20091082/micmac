...
//    labelImages->setStyleSheet("font-weight: bold");
    ...
    boxlayouth1->addWidget(ChSysQt);
    ChSysQt->setFixedWidth(300);
    ChSysQt->setFixedHeight(25);
...
void Convert2GenBundle::mm3d(){
    ...
    if(a<2){
        ...
        if(modo3!=""){
          ...
          modo3 = "ChSys="+ groupBox3->currentText().toStdString();
        }
        ...
        if(ChSysQt->toPlainText()!=""){

          ChSysVar = "ChSys="+ChSysQt->toPlainText().toStdString();
        }
