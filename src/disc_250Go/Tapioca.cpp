...
//    labelImages->setText("Tapioca is a simple tool interface for computing tie points : \n \n");
//    labelImages->setStyleSheet("font-weight: bold");
    ...
    //      VitesseInit] INT
        ...
        DLRQt->setFixedHeight(25);
    //      PPRel] Pt2dr :: {Principal point shift}
//        QLabel *Pat2 = new QLabel(this);
//        Pat2->setText("Pat2");
//        Pat2Qt = new QTextEdit();
//        QHBoxLayout *boxlayouth8 = new QHBoxLayout;
//        boxlayouth8->addWidget(Pat2);
//        boxlayouth8->addWidget(Pat2Qt);
//        Pat2Qt->setFixedWidth(300);
//        Pat2Qt->setFixedHeight(25);
