...
//    labelImages->setStyleSheet("font-weight: bold");
 ...
 //     Out INT
    ...
    //      DebugMMByP] bool :: {Partial file for debug}
        ...
        DebugMMByPQt->setFixedHeight(25);
    ...
    //      OffsetPly] bool :: {Free affine parameter, Def=true}
        ...
        OffsetPlyQt->setFixedHeight(25);
        OffsetPlyQt2->setFixedWidth(99);
        OffsetPlyQt2->setFixedHeight(25);
        OffsetPlyQt3->setFixedWidth(99);
        OffsetPlyQt3->setFixedHeight(25);
...
if(OffsetPlyQt->toPlainText()!=""){
   OffsetPlyVar="OffsetPly="+OffsetPlyQt->toPlainText().toStdString();
    }
if(OffsetPlyQt2->toPlainText()!=""){
   OffsetPlyVar2="OffsetPly2="+OffsetPlyQt2->toPlainText().toStdString();
    }
if(OffsetPlyQt3->toPlainText()!=""){
   OffsetPlyVar3="OffsetPlyQt3="+OffsetPlyQt3->toPlainText().toStdString();
    }
