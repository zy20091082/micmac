...
//      Focs] Pt2dr :: {Keep images with focal length inside range [A,B] (A,B in mm) (Def=keep all)}
    ...
    FocsQt->setFixedHeight(25);
    FocsQt2->setFixedWidth(147);
    FocsQt2->setFixedHeight(25);
...
//      VitesseInit] INT
    ...
    VitesseInitQt->setFixedHeight(25);
//      PPRel] Pt2dr :: {Principal point shift}
    ...
    PPRelQt->setFixedHeight(25);
    PPRelQt2->setFixedWidth(147);
    PPRelQt2->setFixedHeight(25);
...
//      LinkPPaPPs] REAL :: {Link PPa and PPs (double)}
    ...
    LinkPPaPPsQt->setFixedHeight(25);
//      FrozenPoses] string :: {List of frozen poses (pattern)}
    ...
    FrozenPosesQt->setFixedHeight(25);
//      FrozenCenters] string :: {List of frozen centers of poses (pattern)}
    ...
    FrozenCentersQt->setFixedHeight(25);
//      FrozenOrients] string :: {List of frozen orients of poses (pattern)}
    ...
    FrozenOrientsQt->setFixedHeight(25);
//      FreeCalibInit] bool :: {Free calibs as soon as created (Def=false)}
    ...
    FreeCalibInitQt->setFixedHeight(25);
//      FrozenCalibs] string :: {List of frozen calibration (pattern)}
    ...
    FrozenCalibsQt->setFixedHeight(25);
//      FreeCalibs] string :: {List of free calibration (pattern, Def=".*")}
    ...
    FreeCalibsQt->setFixedHeight(25);
...
//      EcInit] Pt2dr :: {Inital threshold for residual def = [100,5.0] }
    ...
    EcInitQt->setFixedHeight(25);
    EcInitQt2->setFixedWidth(147);
    EcInitQt2->setFixedHeight(25);
...
//      CondMaxPano] REAL :: {Precaution for conditionning with Panoramic images, Def=1e4 (old was 0) }
    ...
    CondMaxPanoQt->setFixedHeight(25);
...
//      RankInitPP] INT :: {Order of Principal point initialisation, ref id distotion =2, Def=4}
    ...
    RankInitPPQt->setFixedHeight(25);
...
//      MultipleBlock] bool :: {Multiple block need special caution (only related to Levenberg Markard)}
    ...
    MultipleBlockQt->setFixedHeight(25);
...
//        QTextEdit
       if( FocsQt->toPlainText()!=""){
            FocsVar="Focs="+FocsQt->toPlainText().toStdString();
        }
//        QTextEdit *
       if( FocsQt2->toPlainText()!=""){
            Focs2Var="Focs2="+FocsQt2->toPlainText().toStdString();
        }
//        QTextEdit *
...
//        QTextEdit *
        if(PPRelQt->toPlainText()!=""){
            PPRelVar="PPRel="+PPRelQt->toPlainText().toStdString();
        }
//        QTextEdit *
        if(PPRelQt2->toPlainText()!=""){
            PPRel2Var="PPRel2="+PPRelQt2->toPlainText().toStdString();
        }
//        QTextEdit *
...
//        QTextEdit
        if(EcInitQt->toPlainText()!=""){
            EcInitVar="EcInit="+EcInitQt->toPlainText().toStdString();
        }
//        QTextEdit
        if(EcInitQt2->toPlainText()!=""){
            EcInit2Var="EcInit2="+EcInitQt2->toPlainText().toStdString();
        }
//        QTextEdit
