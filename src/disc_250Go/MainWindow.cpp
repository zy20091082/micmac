...
//    actionLoadProject->setShortcut(QKeySequence("Ctrl+N"));
    ...
    QAction *actionRecentProject = menuProject->addAction("&Recent Projet");
...
//    actionMalt->setShortcut(QKeySequence("Ctrl+H"));
    ...
    // Creation of the menu DRONE WORKFLOW
    QMenu *menuWorklowDrone = menuBar()->addMenu("&Drone WorkFlow");
...
//********************************************************BOUTONS AJOUT/SUPPRESSION IMAGES*******************************************
           ...
           //     std::cout <<size;
                ...
                if(!nameresidu2.isEmpty())
                {
                    for(int a = 0; a<nameresidu2.size(); a++)
                    {
                        ...
                        {
                            //std::cout << itToStrg + " itToStrg \n";
//                            qDebug() << nameresidu2.at(a);
...
void MainWindow::campari(){
    ...
    {  QMessageBox msgBox1;
        msgBox1.setWindowTitle("Campari Erro");
...
void MainWindow::bascule(){
    ...
    {  QMessageBox msgBox1;
        msgBox1.setWindowTitle("Bascule Erro");
...
void MainWindow::vino2(QString otherPath2){
    ...
    if(!listFileFoldersProject.empty()){
        ...
        if(otherPath2!=""){
            ...
            std::cout << str << std::endl;
            killProc = str;
           cmd1 = "xwininfo -root -tree | grep MicMac/Vino";
