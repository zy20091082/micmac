...
if(GpsLaQt->toPlainText()!=""){
    GpsLaVar="GpsLa="+GpsLaQt->toPlainText().toStdString();
}

if(GpsLaQt2->toPlainText()!=""){
    GpsLa2Var="GpsLa2="+GpsLaQt2->toPlainText().toStdString();
}

if(GpsLaQt3->toPlainText()!=""){
    GpsLa3Var="GpsLa3="+GpsLaQt3->toPlainText().toStdString();
}
