...
Bascule::Bascule(QList <QString> list_all, QList <QString> list, QList <QString> listCheckedItems, QString path) : QWidget()
{
    this->setWindowFlags(Qt::WindowStaysOnTopHint);
    setWindowModality(Qt::ApplicationModal); //IMPORTANT, permet que ta fenêtre reste active
    path_s = path.toStdString();
    setWindowTitle("Bascule");
    qDebug()<< path;
...
//    QLabel *outPutBascule = new QLabel(this);
//    outPutBascule->setText("Output folder :");
//    outPutBascule->setStyleSheet("font-weight: bold");
...
//    boxlayoutv->addWidget(outPutBascule);
...
cmd = "mm3d Bascule \""+ images +"\" "+ oriFile +" "+ Xml +" "+ txt + " @ExitOnBrkp";
...
QMessageBox msgBox2;
    msgBox2.setWindowTitle("Bascule");
...
void Bascule::msg(){
    ...
    qDi.setWindowTitle("Bascule state");
...
void Bascule::readyReadStandardOutput(){
